-- =============================================================================
-- DATOS DE EJEMPLO - SISTEMA DE INVENTARIO IOG3
-- =============================================================================
-- Descripción: Inserta datos de ejemplo para pruebas del sistema
-- Fecha: 2025-01-15
-- =============================================================================
...
TRUNCATE TABLE articulo_proveedor;
...
('VARIOS002', 'Otro artículo', 'Otro artículo de ejemplo', 0, 5, 50, 15.00);
...
-- =============================================================================
-- ACTUALIZAR STOCK DESPUÉS DE LAS VENTAS (simulando el trigger)
-- =============================================================================
UPDATE articulos SET stock_actual = stock_actual - 10 WHERE id = 1; -- Tornillos
UPDATE articulos SET stock_actual = stock_actual - 5 WHERE id = 3;  -- Cables
UPDATE articulos SET stock_actual = stock_actual - 20 WHERE id = 4; -- Tuercas
UPDATE articulos SET stock_actual = stock_actual - 2 WHERE id = 2;  -- Cascos (ya en 0)
UPDATE articulos SET stock_actual = stock_actual - 4 WHERE id = 7;  -- Destornilladores
UPDATE articulos SET stock_actual = stock_actual - 15 WHERE id = 5; -- Papel
UPDATE articulos SET stock_actual = stock_actual - 8 WHERE id = 6;  -- Detergente (ya en 0)
